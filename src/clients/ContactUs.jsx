        ...
        <main className="mx-auto md:w-11/12 p-2 md:p-4">
            <div className="md:w-11/12 mx-auto my-3 p-4">
                <div className="address my-5 shadow-md p-3 md:p-4 md:w-10/12 mx-auto text-lg">
                    ...
                    <p>info@teledominternational.net</p>
                </div>
                ...
                <div className="address my-10 shadow-md p-3 md:p-4 md:w-10/12 mx-auto text-lg">
                    ...
                    <p>Tel: 085-660402, +234 906-5770-377, +234 902-3356-081, +234 805-7539-703, +234 908-6714-592</p>
                    <p>uyo@teledominternational.net</p>
                </div>
            </div>
        </main>
     );
